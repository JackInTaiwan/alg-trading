...
if __name__ == "__main__":
    ...
    group.add_argument("--fetch", action="store", type=str, nargs=3, help="fetch data via mongo DB: [ticker] [start_date] [end_date]")
    group.add_argument("--download", action="store", type=str, nargs=4, help="fetch data via mongo DB and download: [ticker] [start_date] [end_date] [save file path]")
